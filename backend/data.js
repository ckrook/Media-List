...
const images = [
  ...
  },
  {
    id: 2,
    title:
      "Apollo 11 Mission image -  Astronaut Edwin Aldrin walks near the Lunar Module",
    description:
  ...
  },
  {
    ...
    description:
      "The Apollo 8 Spacecraft 103/Saturn 503 space vehicle on the way from the Kennedy Space Center's KSC Vehicle Assembly Building VAB to Pad A, Launch Complex 39. The Saturn V stack and its mobile launch tower are atop a huge crawler-transporter.",
